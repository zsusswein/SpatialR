...
transmissibility_over_wildtype <- tibble(lineage = c('alpha', 'beta', 'gamma', 'delta', 'epsilon', 'eta', 'kappa', 'iota', 'zeta', 'other', 'omicron', 'mu'),
                                         transmissibility_multiplier = c(1.5, 1.6, 1.4, 2.4, 1.24, 1.29, 1.48, 1.35, 1, 1, 4.65, 2.25))
...
# https://www.nature.com/articles/s41467-021-25913-9
# https://www.sciencedirect.com/science/article/pii/S2666379122000908
# Alpha, beta, gamma: https://www.nature.com/articles/s41467-021-25913-9
