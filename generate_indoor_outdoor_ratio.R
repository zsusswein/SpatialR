...
df <- read_csv('/Volumes/GoogleDrive/.shortcut-targets-by-id/1TcpYSeCg0cnqIp35Pml5U1nWJqzPDVOR/DATA/Safegraph_data/PROCESSED_DATA/weekly_patterns_county_indooroutdoor_April2021/weekly_patterns_countylevel_summarized2020.csv') %>% 
  rename(fips = countyFIPS) %>% 
  full_join(read_csv('/Volumes/GoogleDrive/.shortcut-targets-by-id/1TcpYSeCg0cnqIp35Pml5U1nWJqzPDVOR/DATA/Safegraph_data/PROCESSED_DATA/weekly_patterns_county_indooroutdoor_April2021/weekly_patterns_countylevel_summarized2021.csv') %>% 
  rename(fips = countyFIPS)) %>% 
...
dat <- vroom('/Volumes/GoogleDrive/.shortcut-targets-by-id/12V72oXyWtm3AbaVo2SKmwnTsnzJvFRii/COVID_BansalLab/DATA/Safegraph_data/PROCESSED_DATA/weekly_patterns_county_indooroutdoor_April2021/weekly_patterns_countylevel_summarized2021.csv')
